import{s as Wa,a,f as r,l as $,c as f,g as u,A as m,h as k,d as n,m as d,i,z as c,C as y}from"../chunks/scheduler.f9d0632e.js";import{S as za,i as Ua,b as v,d as _,m as C,a as g,t as w,e as x}from"../chunks/index.18812859.js";import{T as Ja,S as Ql}from"../chunks/TableOfContents.055f08dc.js";import{C as b}from"../chunks/Code.84be8350.js";import{j as Es}from"../chunks/json.4d993fc0.js";import{p as P}from"../chunks/python.62bbd573.js";import{T as Ya,B as Qa}from"../chunks/Title.3db1f94d.js";import{G as Aa}from"../chunks/GuideImage.3820e700.js";import{b as Kl}from"../chunks/bash.7e4226ac.js";import{A as T}from"../chunks/A.8800f1f3.js";import{G as Ga}from"../chunks/navigation.af8c0806.js";function Ka(p){let o;return{c(){o=$("Git")},l(l){o=d(l,"Git")},m(l,s){i(l,o,s)},d(l){l&&n(o)}}}function Va(p){let o;return{c(){o=$("Python 3.11")},l(l){o=d(l,"Python 3.11")},m(l,s){i(l,o,s)},d(l){l&&n(o)}}}function Xa(p){let o;return{c(){o=$("Pre-commit")},l(l){o=d(l,"Pre-commit")},m(l,s){i(l,o,s)},d(l){l&&n(o)}}}function Za(p){let o;return{c(){o=$("data definition repository on GitHub")},l(l){o=d(l,"data definition repository on GitHub")},m(l,s){i(l,o,s)},d(l){l&&n(o)}}}function ef(p){let o;return{c(){o=$("Fork a repo quickstart guide")},l(l){o=d(l,"Fork a repo quickstart guide")},m(l,s){i(l,o,s)},d(l){l&&n(o)}}}function tf(p){let o=`
...
git push --set-upstream origin adding-my-definition
  `,l;return{c(){l=$(o)},l(s){l=d(s,o)},m(s,h){i(s,l,h)},p:y,d(s){s&&n(l)}}}function Ff(p){let o;return{c(){o=$(`pushing commits to a remote repository
    `)},l(l){o=d(l,`pushing commits to a remote repository
    `)},m(l,s){i(l,o,s)},d(l){l&&n(o)}}}function qf(p){let o;return{c(){o=$("definition repository")},l(l){o=d(l,"definition repository")},m(l,s){i(l,o,s)},d(l){l&&n(o)}}}function Of(p){let o;return{c(){o=$("Creating a pull request")},l(l){o=d(l,"Creating a pull request")},m(l,s){i(l,o,s)},d(l){l&&n(o)}}}function Bf(p){let o=Ga.BUILD_DATA_SOURCE.title+"",l;return{c(){l=$(o)},l(s){l=d(s,o)},m(s,h){i(s,l,h)},p:y,d(s){s&&n(l)}}}function Ef(p){let o;return{c(){o=$("versioning of definitions")},l(l){o=d(l,"versioning of definitions")},m(l,s){i(l,o,s)},d(l){l&&n(o)}}}function Nf(p){let o,l,s,h,M,Bn,Oe,Ns=`Data definitions are the technical specifications for data products, which are the cornerstone
    ...
    installation instructions):`,Sn,q,Hn,D,Vl,Ln,R,Xl,Mn,j,An,je,As="Fork and clone the data definitions repository",Gn,S,Zl,A,es,Wn,G,ts,W,ns,zn,Se,Gs="Set up pre-commit hooks",Un,Ae,Ws=`Open the repository you cloned in a terminal and run <em>pre-commit install</em> to set up the pre-commit
    hooks.`,Jn,z,Yn,Ge,zs="If you get any error at this stage, ensure you've properly installed pre-commit and Python.",Qn,We,Us=`The pre-commit hooks are used to perform some tasks at time you are committing your changes.
    ...
    etc. It can be used like this:`,ji,ne,Si,I,as,gn,Ho="Field()",fs,wn,Lo="None",rs,xn,Mo="null",us,yn,Fo="...",ps,ie,ms,Ai,It,qo="The end result of the two above examples are identical.",Gi,Pt,Oo=`Let&#39;s now add a title, description and an example and min/max length to ensure it&#39;s a two letter
    ...
    <em>List</em>, like this (see the last line):`,dl,ve,hl,At,Qo=`However, right now, the <em>capital</em> would be a mandatory field in the response. But we
    ...
    running:`,Bl,be,El,ke,ys,Te,bs,Nl,nn,fa="Create a pull request",Dl,Ie,ks,Pe,Ts,Rl,He,Is,Le,Ps,jl,ln,ra="The flow should look pretty much like this:",Sl,sn,Al,on,ua="Wait for maintainers to merge it",Gl,an,pa=`The next step is to just wait for maintainers to accept and merge the pull request. In some
  ...
  `),wt=r("p"),wt.innerHTML=yo,Oi=a(),xt=r("h3"),xt.textContent=bo,Bi=a(),yt=r("p"),yt.textContent=ko,Ei=a(),v(te.$$.fragment),Ni=a(),bt=r("p"),bt.innerHTML=To,Di=a(),kt=r("p"),kt.textContent=Io,Ri=a(),Tt=r("p"),Tt.innerHTML=Po,ji=a(),v(ne.$$.fragment),Si=a(),I=r("p"),as=$("The first argument to "),gn=r("em"),gn.textContent=Ho,fs=$(` is the default value of the field, which defaults to
    ...
    `),v(ie.$$.fragment),ms=$("."),Ai=a(),It=r("p"),It.textContent=qo,Gi=a(),Pt=r("p"),Pt.innerHTML=Oo,Wi=a(),v(le.$$.fragment),zi=a(),Ht=r("p"),Ht.textContent=Bo,Ui=a(),se=r("p"),$s=$(`For more details on these parameters refer to the
    ...
    `),v(ue.$$.fragment),cs=$(`, in
    this case the `),bn=r("em"),bn.textContent=Ao,vs=$(". We need to import it like this (at the top of the file):"),il=a(),v(pe.$$.fragment),ll=a(),Et=r("p"),Et.innerHTML=Go,sl=a(),v(me.$$.fragment),ol=a(),Nt=r("h3"),Nt.textContent=Wo,al=a(),Dt=r("p"),Dt.textContent=zo,fl=a(),v($e.$$.fragment),rl=a(),de=r("p"),_s=$(`To do this, we'll use
    `),v(he.$$.fragment),Cs=$(" in pydantic."),ul=a(),Rt=r("p"),Rt.innerHTML=Uo,pl=a(),v(ce.$$.fragment),ml=a(),jt=r("p"),jt.innerHTML=Jo,$l=a(),St=r("p"),St.innerHTML=Yo,dl=a(),v(ve.$$.fragment),hl=a(),At=r("p"),At.innerHTML=Qo,cl=a(),v(_e.$$.fragment),vl=a(),Gt=r("p"),Gt.innerHTML=Ko,_l=a(),v(Ce.$$.fragment),Cl=a(),Wt=r("p"),Wt.innerHTML=Vo,gl=a(),zt=r("p"),zt.innerHTML=Xo,wl=a(),v(ge.$$.fragment),xl=a(),Ut=r("h3"),Ut.textContent=Zo,yl=a(),Jt=r("p"),Jt.innerHTML=ea,bl=a(),v(we.$$.fragment),kl=a(),v(Yt.$$.fragment),Tl=a(),Qt=r("h3"),Qt.textContent=ta,Il=a(),Kt=r("p"),Kt.textContent=na,Pl=a(),B=r("p"),gs=$(`Let's add the new definition file to it and run the pre-commit hooks to see that it creates the
