import{s as $i,a as l,f as d,l as u,c as r,g as m,h as q,m as f,d as n,A as c,i as o,z as p,C as O}from"../chunks/scheduler.f9d0632e.js";import{S as ci,i as hi,b as h,d as g,m as y,a as w,t as v,e as _}from"../chunks/index.18812859.js";import{T as gi,S as k}from"../chunks/TableOfContents.141dc527.js";import{C as _e}from"../chunks/Code.ebc36090.js";import{j as Va}from"../chunks/json.4d993fc0.js";import{p as jt}from"../chunks/python.62bbd573.js";import{T as yi,B as wi}from"../chunks/Title.363df23c.js";import{G as xe}from"../chunks/navigation.c12b1252.js";import{G as mi}from"../chunks/GuideImage.3820e700.js";import{A as T}from"../chunks/A.4156af71.js";function vi($){let s;return{c(){s=u(`IOXIO Sandbox Dataspace
...
`,a;return{c(){a=u(s)},l(i){a=f(i,s)},m(i,x){o(i,a,x)},p:O,d(i){i&&n(a)}}}function Fi($){let s;return{c(){s=u("FastAPI documentation")},l(a){s=f(a,"FastAPI documentation")},m(a,i){o(a,s,i)},d(a){a&&n(s)}}}function Oi($){let s;return{c(){s=u("request body")},l(a){s=f(a,"request body")},m(a,i){o(a,s,i)},d(a){a&&n(s)}}}function Ri($){let s;return{c(){s=u("response models")},l(a){s=f(a,"response models")},m(a,i){o(a,s,i)},d(a){a&&n(s)}}}function Bi($){let s;return{c(){s=u("handling errors")},l(a){s=f(a,"handling errors")},m(a,i){o(a,s,i)},d(a){a&&n(s)}}}function ji($){let s=xe.VERIFYING_API_TOKENS.title+"",a;return{c(){a=u(s)},l(i){a=f(i,s)},m(i,x){o(i,a,x)},p:O,d(i){i&&n(a)}}}function Ni($){let s=`
  curl --include \\
  --request POST \\
...
{"message":"Data source returned an error","status":404,"error":{"detail":"Country not found"}}
  ...
  `,a;return{c(){a=u(s)},l(i){a=f(i,s)},m(i,x){o(i,a,x)},p:O,d(i){i&&n(a)}}}function Gi($){let s,a,i,x,A,Nt,Y,oa,K,ia,zt,be,St,Ce,Za="Data that you want to provide.",Gt,Ie,Qa="A data source definition for the data.",Ut,Te,eo=`Ability to host an API that responds to <em>POST</em> requests on the public internet over the https
    protocol.`,Wt,Pe,Xt,J,sa,V,la,Yt,Z,ra,Q,ua,Kt,Me,Jt,R,fa,vt,to="test/ioxio-dataspace-guides/Country/BasicInfo",pa,ee,da,Vt,Le,no=`In this case it means we will create an API that accepts a <em>POST</em> request at the path
    ...
    exception in case the country is not found.`,In,b,Ra,Ht,To="BasicCountryInfoResponse",Ba,qt,Po="response_model",ja,me,Na,$e,za,ce,Sa,he,Ga,Tn,Ue,Pn,We,Mo=`Deploy and host your productizer. For the next steps we will need the base URL at which it is
    ...
    available on all dataspaces):`,Rn,z,Dt,Ro="<b>No access control</b> - The dataspace will allow anyone to request data from the data source.",Ua,Ft,Bo=`<b>Self-managed API keys</b> - <em>X-API-Key</em> header will be required to be present, but its
      contents will not be verified by the dataspace.`,Wa,D,Ot,jo="Dataspace verified API tokens",Xa,Rt,No="X-API-Key",Ya,Bt,zo="Access control keys",Ka,ge,Ja,Bn,at,So=`For this tutorial, let&#39;s for simplicity choose <em>Private</em> for the visibility and
    ...
    definition by following the `),h(Q.$$.fragment),ua=u(" guide."),Kt=l(),h(Me.$$.fragment),Jt=l(),R=d("p"),fa=u(`In this guide we will build a productizer that provides an API matching the
    ...
    friendly format.`),Vt=l(),Le=d("p"),Le.innerHTML=no,Zt=l(),ke=d("p"),ke.innerHTML=ao,Qt=l(),h(te.$$.fragment),en=l(),Ae=d("p"),Ae.textContent=oo,tn=l(),h(ne.$$.fragment),nn=l(),Ee=d("p"),Ee.textContent=io,an=l(),h(He.$$.fragment),on=l(),B=d("p"),ma=u("We will use the "),h(ae.$$.fragment),$a=u(` based
    ...
    `),h(ue.$$.fragment),Oa=u(" section of the FastAPI docs."),cn=l(),Re=d("p"),Re.innerHTML=_o,hn=l(),h(fe.$$.fragment),gn=l(),h(Be.$$.fragment),yn=l(),je=d("p"),je.innerHTML=xo,wn=l(),h(pe.$$.fragment),vn=l(),Ne=d("p"),Ne.innerHTML=bo,_n=l(),h(ze.$$.fragment),xn=l(),Se=d("p"),Se.innerHTML=Co,bn=l(),h(de.$$.fragment),Cn=l(),Ge=d("p"),Ge.innerHTML=Io,In=l(),b=d("p"),Ra=u("Finally we wrap the data into a "),Ht=d("em"),Ht.textContent=To,Ba=u(`. We could as well just return
    ...
    resources are well worth a look if the explanation in this guide was too brief.`),Tn=l(),h(Ue.$$.fragment),Pn=l(),We=d("p"),We.innerHTML=Mo,Mn=l(),h(Xe.$$.fragment),Ln=l(),Ye=d("p"),Ye.textContent=Lo,kn=l(),Ke=d("h3"),Ke.textContent=ko,An=l(),Je=d("p"),Je.textContent=Ao,En=l(),Ve=d("h3"),Ve.textContent=Eo,Hn=l(),Ze=d("p"),Ze.innerHTML=Ho,qn=l(),Qe=d("p"),Qe.textContent=qo,Dn=l(),et=d("p"),et.textContent=Do,Fn=l(),tt=d("ul"),tt.innerHTML=Fo,On=l(),nt=d("p"),nt.textContent=Oo,Rn=l(),z=d("ul"),Dt=d("li"),Dt.innerHTML=Ro,Ua=l(),Ft=d("li"),Ft.innerHTML=Bo,Wa=l(),D=d("li"),Ot=d("b"),Ot.textContent=jo,Xa=u(" - The "),Rt=d("em"),Rt.textContent=No,Ya=u(` header will be required and
      ...
      `),Bt=d("em"),Bt.textContent=zo,Ka=u(`
      ...
      requesting the data.`),Bn=l(),at=d("p"),at.innerHTML=So,jn=l(),h(ot.$$.fragment),Nn=l(),it=d("p"),it.innerHTML=Go,zn=l(),h(st.$$.fragment),Sn=l(),lt=d("p"),lt.innerHTML=Uo,Gn=l(),h(rt.$$.fragment),Un=l(),ut=d("p"),ut.innerHTML=Wo,Wn=l(),h(ye.$$.fragment),Xn=l(),ft=d("p"),ft.innerHTML=Xo,Yn=l(),pt=d("p"),pt.textContent=Yo,Kn=l(),h(we.$$.fragment),Jn=l(),h(ve.$$.fragment),Vn=l(),h(dt.$$.fragment),Zn=l(),mt=d("p"),mt.innerHTML=Ko,Qn=l(),h($t.$$.fragment),ea=l(),ct=d("p"),ct.innerHTML=Jo,ta=l(),ht=d("p"),ht.innerHTML=Vo,na=l(),gt=d("p"),gt.textContent=Zo},l(e){g(s.$$.fragment,e),a=r(e),g(i.$$.fragment,e),x=r(e),g(A.$$.fragment,e),Nt=r(e),Y=m(e,"P",{});var t=q(Y);oa=f(t,`In this guide we will explain how to build a new data source or productizer and how to use the
    developer portal to publish it using the developer portal so it can be queried through the
    ...
    definition by following the `),g(Q.$$.fragment,wt),ua=f(wt," guide."),wt.forEach(n),Kt=r(e),g(Me.$$.fragment,e),Jt=r(e),R=m(e,"P",{});var S=q(R);fa=f(S,`In this guide we will build a productizer that provides an API matching the
    ...
    definitions repository. If they are not available you will have to build them yourself. In that
    case the same guide can be handy, as well as the official pydantic documentation and the
    `),g(ue.$$.fragment,W),Oa=f(W," section of the FastAPI docs."),W.forEach(n),cn=r(e),Re=m(e,"P",{"data-svelte-h":!0}),c(Re)!=="svelte-sjvjvy"&&(Re.innerHTML=_o),hn=r(e),g(fe.$$.fragment,e),gn=r(e),g(Be.$$.fragment,e),yn=r(e),je=m(e,"P",{"data-svelte-h":!0}),c(je)!=="svelte-1qv0iow"&&(je.innerHTML=xo),wn=r(e),g(pe.$$.fragment,e),vn=r(e),Ne=m(e,"P",{"data-svelte-h":!0}),c(Ne)!=="svelte-nhz6t8"&&(Ne.innerHTML=bo),_n=r(e),g(ze.$$.fragment,e),xn=r(e),Se=m(e,"P",{"data-svelte-h":!0}),c(Se)!=="svelte-6ah2bj"&&(Se.innerHTML=Co),bn=r(e),g(de.$$.fragment,e),Cn=r(e),Ge=m(e,"P",{"data-svelte-h":!0}),c(Ge)!=="svelte-13aznig"&&(Ge.innerHTML=Io),In=r(e),b=m(e,"P",{});var C=q(b);Ra=f(C,"Finally we wrap the data into a "),Ht=m(C,"EM",{"data-svelte-h":!0}),c(Ht)!=="svelte-iyvrvd"&&(Ht.textContent=To),Ba=f(C,`. We could as well just return
    the data as a dictionary and let FastAPI take care of the rest automatically using the
    definition in the
