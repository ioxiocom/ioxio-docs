import{s as pe,a as C,f as u,l as r,c as v,g as p,z as h,h as Tt,m as f,d as m,i as $,y as s,B as ue}from"../chunks/scheduler.2e48bd10.js";import{S as $e,i as ge,b as w,d as y,m as k,a as b,t as E,e as j}from"../chunks/index.ed958696.js";import{T as he,S as le}from"../chunks/TableOfContents.947bbe08.js";import{C as re}from"../chunks/Code.e8e0e89f.js";import{j as fe}from"../chunks/json.4d993fc0.js";import{A as At}from"../chunks/A.6e646f1b.js";import{T as de,B as ce}from"../chunks/Title.e984b84c.js";import{G as me}from"../chunks/GuideImage.dd604073.js";function _e(g){let n;return{c(){n=r("party configuration schema")},l(a){n=f(a,"party configuration schema")},m(a,o){$(a,n,o)},d(a){a&&m(n)}}}function xe(g){let n;return{c(){n=r("https://docs.ioxio.dev/schemas/party-configuration")},l(a){n=f(a,"https://docs.ioxio.dev/schemas/party-configuration")},m(a,o){$(a,n,o)},d(a){a&&m(n)}}}function Ce(g){let n=`
{
...
`,a;return{c(){a=r(n)},l(o){a=f(o,n)},m(o,_){$(o,a,_)},p:ue,d(o){o&&m(a)}}}function ve(g){let n;return{c(){n=r("https://ioxio.com/.well-known/jwks.json")},l(a){n=f(a,"https://ioxio.com/.well-known/jwks.json")},m(a,o){$(a,n,o)},d(a){a&&m(n)}}}function we(g){let n=`
{
  "keys": [
    ...
    it, add the party configuration domain and click the update button.`,ot,T,at,A,st,N,it,O,Ot=`<strong>1.</strong>
    ...
    on that domain and it needs to be accessible over <em>https://</em> with a valid certificate.`,lt,S,B,Bt="2.",$t,P,Pt="party-configuration.json",gt,M,ht,rt,d,V,Vt="3.",dt,H,Ht="jwks_uri",ct,z,zt="https://",_t,L,Lt="/.well-known/jwks.json",xt,Ct,vt,R,wt,ft,q,mt,i,U,Ut="4.",yt,W,Wt="jwks_uri",kt,J,Jt="kid",bt,Y,Yt="kty",Et,D,Dt="RSA",jt,X,Xt="use",St,K,Kt="sig",Mt,Q,Qt="alg",Rt,Z,Zt="RS256",qt,tt,te="n",It,et,ee="e",Ft,I,Gt,ut,F,pt;return n=new de({props:{title:g[0].guide.title}}),o=new ce({props:{path:g[0].path}}),x=new le({props:{title:"Introduction"}}),T=new me({props:{img:g[1].PAGE_FOR_CREATING_GROUPS}}),A=new me({props:{img:g[1].EDITING_A_GROUP}}),N=new le({props:{title:"Creating and hosting party configuration"}}),M=new At({props:{href:"/schemas/party-configuration/",$$slots:{default:[_e]},$$scope:{ctx:g}}}),R=new At({props:{href:"/schemas/party-configuration",$$slots:{default:[xe]},$$scope:{ctx:g}}}),q=new re({props:{lang:fe,$$slots:{default:[Ce]},$$scope:{ctx:g}}}),I=new At({props:{href:"https://ioxio.com/.well-known/jwks.json",$$slots:{default:[ve]},$$scope:{ctx:g}}}),F=new re({props:{lang:fe,$$slots:{default:[we]},$$scope:{ctx:g}}}),{c(){w(n.$$.fragment),a=C(),w(o.$$.fragment),_=C(),w(x.$$.fragment),nt=C(),G=u("p"),G.textContent=Nt,ot=C(),w(T.$$.fragment),at=C(),w(A.$$.fragment),st=C(),w(N.$$.fragment),it=C(),O=u("p"),O.innerHTML=Ot,lt=C(),S=u("p"),B=u("strong"),B.textContent=Bt,$t=r(`
    ...
    `),w(I.$$.fragment),Gt=r(":"),ut=C(),w(F.$$.fragment)},l(t){y(n.$$.fragment,t),a=v(t),y(o.$$.fragment,t),_=v(t),y(x.$$.fragment,t),nt=v(t),G=p(t,"P",{"data-svelte-h":!0}),h(G)!=="svelte-15c39j3"&&(G.textContent=Nt),ot=v(t),y(T.$$.fragment,t),at=v(t),y(A.$$.fragment,t),st=v(t),y(N.$$.fragment,t),it=v(t),O=p(t,"P",{"data-svelte-h":!0}),h(O)!=="svelte-gg2a3h"&&(O.innerHTML=Ot),lt=v(t),S=p(t,"P",{});var e=Tt(S);B=p(e,"STRONG",{"data-svelte-h":!0}),h(B)!=="svelte-83a0bo"&&(B.textContent=Bt),$t=f(e,`
    ...
    for more details.`),e.forEach(m),rt=v(t),d=p(t,"P",{});var c=Tt(d);V=p(c,"STRONG",{"data-svelte-h":!0}),h(V)!=="svelte-hj6ifl"&&(V.textContent=Vt),dt=f(c,`
    ...
    `),y(R.$$.fragment,c),wt=f(c,":"),c.forEach(m),ft=v(t),y(q.$$.fragment,t),mt=v(t),i=p(t,"P",{});var l=Tt(i);U=p(l,"STRONG",{"data-svelte-h":!0}),h(U)!=="svelte-1nm293q"&&(U.textContent=Ut),yt=f(l,`
